...
public interface UserService {
    ...
    @GET("users/")
    Call<UserResults> getUsers(@Query("accessToken") String accessToken, @Query("offset") int offset, @Query("limit") int limit, @Query("fingerprintStatus") String filterByOption, @Query("order") String orderOption, @Query("sortBy") String sortByOption, @Query("username") String searchOption);
